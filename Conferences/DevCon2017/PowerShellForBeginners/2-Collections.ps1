...
Get-CMCollection | Out-GridView
Get-CMCollection -name "test1" | select name
Get-CMCollection -name "test1*" | select name
...
#Wild Card Handling
Get-CMCollection -name "test1*" -DisableWildcardHandling | select name

Get-CMCollection -name "test1*" -ForceWildcardHandling | select name
...
#use Get-CMDevice to list systems in a collection
Show-Command Get-CMDevice
